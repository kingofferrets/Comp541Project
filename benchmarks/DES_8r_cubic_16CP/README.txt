...
DES_8b.anf is a lightly modified version, some simple replacements to help get it into the right format for CNF conversion.
DES_8c.anf is after running a simple Python script that converts DES_8b.anf into the format accepted by anf2cnf.
